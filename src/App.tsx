...
function App() {
  ...
  return (
    <div className="chat_wrapper">
      <div className="row">
        <span className="icon_wrapper"><img src={back} className="img" alt="后退" /></span>
        <span className="title">用户1</span>
        <span className="icon_wrapper"><img src={dot} className="img" alt="点" /></span>
      </div>
      ...
      <div className="input_area">
        <img src={voice} alt="语音" className="icon_img" />
        <input
          type="text"
          placeholder="请输入..."
          className="input_box"
        ...
        />
        <img src={face} alt="表情" className="icon_img" />
        <img src={plus} alt="更多" className="icon_img" />
      </div>
    </div>
  )
}
